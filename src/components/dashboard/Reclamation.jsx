      ...
      >
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-left mb-1">Type de problème</label>
              <select 
                name="subject" 
            ...
            <div>
              <label className="block text-sm font-medium text-left mb-1">Nom complet</label>
              <input 
                type="text" 
                name="client_name" 
          ...
          <div className="mt-4">
            <label className="block text-sm font-medium text-left mb-1">Description du problème</label>
            <textarea 
              name="description" 
          ...
          <div className="mt-4">
            <label className="block text-sm font-medium text-left mb-1">Pièces jointes (optionnel)</label>
            <input 
              type="file" 
              multiple
