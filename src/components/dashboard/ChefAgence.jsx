          ...
          <form onSubmit={handleSaveMember} className="space-y-6 bg-white rounded-2xl shadow-2xl p-8 border-t-8 border-blue-600 max-w-lg mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select className="border-2 border-blue-200 rounded-lg px-4 py-2 w-full focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-lg transition" value={memberForm.agency || 'Siège'} onChange={e => setMemberForm({ ...memberForm, agency: e.target.value })} required>
