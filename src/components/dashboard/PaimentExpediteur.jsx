                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="block w-full px-3 py-2 border-2 border-gray-300 rounded-md text-left text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 hover:border-gray-400"
                        required
                      >
                        <option value="">-- Sélectionner une agence --</option>
                        {agencyOptions.map(agency => (
                          <option key={agency} value={agency} className="text-left">
                            {agency}
                          </option>
                        ))}
                      </select>
                    ...
                    <div className="flex items-end">
                      <div className="bg-blue-50 rounded-md p-2 border border-blue-200">
                        <p className="text-xs text-blue-700 text-left">
                          L'agence détermine les expéditeurs disponibles
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div>
              ...
              <select 
                ...
                onChange={handleInputChange} 
                        className={`block w-full px-3 py-2 border-2 rounded-md text-left text-sm transition-all duration-200 ${
                          !selectedAgency 
                ...
                required
                      ...
                      >
                        <option value="" className="text-left">
                          {selectedAgency ? "-- Sélectionner un expéditeur --" : "-- Sélectionnez d'abord une agence --"}
                        </option>
                        {filteredShippers.map(shipper => (
                          <option key={shipper.id} value={shipper.id} className="text-left">
                    ...
                    <div className="flex items-end">
                      <div className="bg-green-50 rounded-md p-2 border border-green-200">
                        <p className="text-xs text-green-700 text-left">
                          {filteredShippers.length} expéditeur(s) disponible(s) pour cette agence
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div>
              ...
              <select 
                ...
                required
                        className="block w-full px-3 py-2 border-2 border-gray-300 rounded-md text-left text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-gray-400"
                      >
                        <option value="" className="text-left">Sélectionner une méthode</option>
                        <option value="Espèces" className="text-left">💵 Espèces</option>
                        <option value="Paiement avec chèque" className="text-left">📄 Paiement avec chèque</option>
                        <option value="Virements bancaires" className="text-left">🏦 Virements bancaires</option>
              </select>
            </div>
            <div>
                      <label className="block text-xs font-medium text-gray-700 mb-2 text-left">
            ...
            <div>
              ...
              <select 
                ...
                onChange={handleInputChange} 
                        className="block w-full px-3 py-2 border-2 border-gray-300 rounded-md text-left text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 hover:border-gray-400"
                      >
                        <option value="En attente" className="text-left">En attente</option>
                        <option value="Payé" className="text-left">Payé</option>
                      </select>
                    </div>
                  </div>
                </div>
