            ...
            <div className="space-y-6">
              ...
              <div className="mb-8">
                <div className="flex items-center justify-center space-x-4">
                  {[
                    { step: 1, title: "Livreur", icon: "🚗", color: "blue" },
                    { step: 2, title: "Expéditeurs", icon: "👥", color: "green" },
                    { step: 3, title: "Colis", icon: "📦", color: "purple" },
                    { step: 4, title: "Création", icon: "✅", color: "orange" }
                  ].map((stepInfo, index) => (
