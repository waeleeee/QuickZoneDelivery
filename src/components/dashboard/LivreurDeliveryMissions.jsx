    ...
    <div className="space-y-6">
        ...
        {selectedMission && (
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <h4 className="text-lg font-semibold text-gray-900 mb-3 text-left">Informations de la Mission</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="text-left">
                  <label className="block text-sm font-medium text-gray-700 text-left">Numéro de Mission</label>
                  <p className="text-sm text-gray-900 font-mono text-left">{selectedMission.mission_number}</p>
                </div>
                <div className="text-left">
                  <label className="block text-sm font-medium text-gray-700 text-left">Entrepôt</label>
                  <p className="text-sm text-gray-900 text-left">{selectedMission.warehouse_name || 'N/A'}</p>
                </div>
                <div className="text-left">
                  <label className="block text-sm font-medium text-gray-700 text-left">Date de Livraison</label>
                  <p className="text-sm text-gray-900 text-left">
                    {new Date(selectedMission.delivery_date).toLocaleDateString('fr-FR')}
                  </p>
                </div>
                <div className="text-left">
                  <label className="block text-sm font-medium text-gray-700 text-left">Statut</label>
                  <div className="mt-1 text-left">{statusBadge(selectedMission.status)}</div>
                </div>
              </div>
            </div>
            ...
            {/* Parcels Information */}
            <div>
              <h4 className="text-lg font-semibold text-gray-900 mb-3 text-left">Colis à Livrer ({missionParcels.length})</h4>
              {loadingParcels ? (
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm mb-3">
                            <div className="text-left">
                              <label className="block text-xs font-medium text-gray-700 text-left">Destinataire</label>
                              <p className="text-gray-900 text-left">{parcel.recipient_name || 'N/A'}</p>
                            </div>
                            <div className="text-left">
                              <label className="block text-xs font-medium text-gray-700 text-left">Téléphone</label>
                              <p className="text-gray-900 text-left">{parcel.recipient_phone || 'N/A'}</p>
                            </div>
                            <div className="md:col-span-2 text-left">
                              <label className="block text-xs font-medium text-gray-700 text-left">Adresse</label>
      ...
      >
        <div className="space-y-6">
          ...
          {/* Parcels List */}
          <div>
            <h4 className="text-sm font-medium text-gray-900 mb-3 text-left">Colis de la mission</h4>
      ...
      >
       ...
       >
         <div className="space-y-4 text-left">
           ...
           <div>
             <label className="block text-sm font-medium text-gray-700 text-left">Code de Sécurité</label>
             <input
               type="text"
       ...
       >
         <div className="space-y-4 text-left">
           <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
             <h4 className="text-sm font-medium text-red-900 mb-2 text-left">
               Colis #{selectedParcelForAccept?.tracking_number}
             </h4>
       ...
       >
         <div className="space-y-4 text-left">
           <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-4">
             <h4 className="text-sm font-medium text-orange-900 mb-2 text-left">
               Colis #{selectedParcelForAccept?.tracking_number}
             </h4>
