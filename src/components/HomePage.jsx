              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="group">
                      ...
                      <div className="relative">
                        <select className="w-full p-5 bg-white border-2 border-gray-200 rounded-2xl focus:outline-none focus:ring-4 focus:ring-red-500/20 focus:border-red-500 transition-all duration-300 text-gray-900 text-lg shadow-sm hover:shadow-md appearance-none">
                          ...
                          <option>Service client insatisfaisant</option>
                          <option>Autre</option>
                        </select>
                        <div className="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                ...
                <div className="mb-8">
                  <div className="flex items-start space-x-3 p-4 bg-red-50 rounded-2xl border border-red-200">
                    <input type="checkbox" id="confirm" className="w-5 h-5 text-red-600 mt-1 rounded focus:ring-red-500" />
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="group flex-1 relative bg-gradient-to-r from-red-600 to-red-700 text-white px-8 py-5 rounded-2xl text-lg font-bold hover:from-red-700 hover:to-red-800 hover:shadow-2xl transition-all duration-300 transform hover:scale-105 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-red-700 to-red-800 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="relative flex items-center justify-center gap-3">
                  ...
                  <button className="flex-1 bg-gray-200 text-gray-700 px-8 py-5 rounded-2xl text-lg font-bold hover:bg-gray-300 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                ...
                <div className="text-center mt-8">
                  <div className="inline-flex items-center gap-4 bg-green-50 text-green-700 px-6 py-3 rounded-full text-sm font-semibold">
                    <i className="fas fa-clock text-green-500"></i>
